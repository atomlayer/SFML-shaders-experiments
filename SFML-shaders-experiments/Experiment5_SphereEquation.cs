...
{
    class Experiment5_SphereEquation : Game
    {
        public Experiment5_SphereEquation(RenderTo render) 
            : base(1800, 1000, "Experiment5_SphereEquation", Color.Blue,render)
        {
